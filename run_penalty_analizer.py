...
def main() -> None:
	...
	print("Ball Tracking:           YOLO refresh + previous-position ROI/reuse")
	...
	print(f"Global Process Cadence:  every {ModelConfig.PROCESS_EVERY_N_FRAMES} frame(s)")
	print(f"Mask Side Padding Ratio: {ModelConfig.MASK_SIDE_PADDING_RATIO}")
	print(f"Mask Top Padding Ratio:  {ModelConfig.MASK_TOP_PADDING_RATIO}")
